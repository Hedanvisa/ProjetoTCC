...
class Admin::PeriodosControllerTest < ActionController::TestCase
  setup do
    @admin_periodo = admin_periodos(:one)
  end
  ...
  test "should create admin_periodo" do
    assert_difference('Admin::Periodo.count') do
      post :create, admin_periodo: { inicio: @admin_periodo.inicio, termino: @admin_periodo.termino }
    end
  ...
  test "should update admin_periodo" do
    patch :update, id: @admin_periodo, admin_periodo: { inicio: @admin_periodo.inicio, termino: @admin_periodo.termino }
    assert_redirected_to admin_periodo_path(assigns(:admin_periodo))
  end
